...
require "tmpdir"
BackupStorage::Blob.service = BackupStorage::Service::DiskService.new(root: Dir.mktmpdir("backup_storage_tests"))
BackupStorage::Service.logger = ActiveSupport::Logger.new(STDOUT)

BackupStorage.verifier = ActiveSupport::MessageVerifier.new("Testing")
...
class ActiveSupport::TestCase
  ...
  private
    def create_blob(data: "Hello world!", filename: "hello.txt", content_type: "text/plain")
      BackupStorage::Blob.create_after_upload! io: StringIO.new(data), filename: filename, content_type: content_type
    end
    ...
    def create_blob_before_direct_upload(filename: "hello.txt", byte_size:, checksum:, content_type: "text/plain")
      BackupStorage::Blob.create_before_direct_upload! filename: filename, byte_size: byte_size, checksum: checksum, content_type: content_type
    end
...
require "global_id"
GlobalID.app = "BackupStorageExampleApp"
